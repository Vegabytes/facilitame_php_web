...
console.log(`%c  my-services  `, `background: #CC0000; color: white`); // Red / White // DEV
...
var KTCustomersList = function ()
{
    ...
    {
        const filterSearch = document.querySelector('[data-kt-services-table-filter="status"]');
    ...
    return {
        init: function ()
        {
            table = document.querySelector('#kt_services_table');
