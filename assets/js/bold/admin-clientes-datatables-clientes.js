...
var DatatablesProveedorClientes = function ()
{
    ...
    const handleCustomerActionClientes = () =>
    {
        $(document).on("click", ".customer-get-info", async function (e)
        {
            ...
            let ajaxurl = "/api/admin-customer-get-requests";
            let data = {
    ...
    return {
        init: function ()
        {
            console.log(`%c  init  `, `background: #CC0000; color: white`); // Red / White // DEV
...
{
    console.log(`%c  admin-clientes-datatables-clientes  `, `background: #222; color: #bada55`); // Black / Green // DEV
