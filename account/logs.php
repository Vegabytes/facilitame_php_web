			...
			<div class="app-page flex-column flex-column-fluid" id="kt_app_page">
				...
				<div id="kt_app_header" class="app-header">
						...
						<div class="app-container container-fluid d-flex align-items-stretch justify-content-between" id="kt_app_header_primary_container">
							...
							<div class="d-flex align-items-center align-items-stretch justify-content-between flex-row-fluid" id="kt_app_header_wrapper">
								...
								<div class="d-flex align-items-stretch" id="kt_app_header_menu_wrapper">
									...
									<div class="app-header-menu app-header-mobile-drawer align-items-stretch" data-kt-drawer="true" data-kt-drawer-name="app-header-menu" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="{default:'200px', '300px': '250px'}" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_app_header_menu_toggle" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_app_body', lg: '#kt_app_header_menu_wrapper'}">
										...
										<div class="menu menu-rounded menu-column menu-lg-row menu-active-bg menu-title-gray-600 menu-state-gray-900 menu-arrow-gray-500 fw-semibold fw-semibold fs-6 align-items-stretch my-5 my-lg-0 px-2 px-lg-0" id="#kt_app_header_menu" data-kt-menu="true">
											...
											<!--end:Menu item-->
											<!--begin:Menu item-->
											<div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="bottom-start" data-kt-menu-offset="-400,0" class="menu-item here show">
												<!--begin:Menu link-->
												<span class="menu-link">
								...
								<div class="app-navbar flex-shrink-0">
									...
									<!--begin::Action-->
									<div class="app-navbar-item ms-2 ms-md-5">
										<a href="#" class="btn btn-flex btn-sm fw-bold btn-dark py-3" data-bs-toggle="modal" data-bs-target="#kt_modal_upgrade_plan">Try Now</a>
									</div>
									<!--end::Action-->
					...
					<div class="app-header-secondary">
						...
						<div class="app-container container-fluid" id="kt_app_header_secondary_container">
							<!--begin::Header secondary-->
							<div class="d-flex align-items-center align-items-stretch justify-content-end h-100">
								<!--begin::Search-->
								<div class="d-flex align-items-center align-items-stretch me-7 me-lg-10">
									<!--begin::Search-->
												...
												<table class="table align-middle table-row-dashed fw-semibold text-gray-600 fs-6 gy-5" id="kt_table_customers_logs">
													...
													<tbody>
														...
														<tr>
															...
															<!--end::Badge=-->
															<!--begin::Status=-->
															<td>POST /v1/invoices/in_3407_2525/payment</td>
															<!--end::Status=-->
															<!--begin::Timestamp=-->
														...
														<tr>
															...
															<!--end::Badge=-->
															<!--begin::Status=-->
															<td>POST /v1/invoices/in_9596_8700/payment</td>
															<!--end::Status=-->
															<!--begin::Timestamp=-->
															<td class="pe-0 text-end min-w-200px">20 Dec 2024, 5:20 pm</td>
															<!--end::Timestamp=-->
														</tr>
														<!--end::Table row-->
														<!--begin::Table row-->
														<tr>
															...
															<!--end::Badge=-->
															<!--begin::Status=-->
															<td>POST /v1/invoice/in_9025_6172/invalid</td>
															<!--end::Status=-->
															<!--begin::Timestamp=-->
														...
														<tr>
															...
															<!--end::Status=-->
															<!--begin::Timestamp=-->
															<td class="pe-0 text-end min-w-200px">22 Sep 2024, 10:10 pm</td>
															<!--end::Timestamp=-->
														</tr>
														<!--end::Table row-->
														<!--begin::Table row-->
														<tr>
															...
															<!--end::Badge=-->
															<!--begin::Status=-->
															<td>POST /v1/invoice/in_2789_7207/invalid</td>
															<!--end::Status=-->
															<!--begin::Timestamp=-->
														...
														<tr>
															...
															<!--end::Badge=-->
															<!--begin::Status=-->
															<td>POST /v1/invoice/in_8089_9104/invalid</td>
															<!--end::Status=-->
															<!--begin::Timestamp=-->
														...
														<tr>
															...
															<!--end::Badge=-->
															<!--begin::Status=-->
															<td>POST /v1/invoices/in_3591_4312/payment</td>
															<!--end::Status=-->
															<!--begin::Timestamp=-->
														...
														<tr>
															...
															<!--end::Badge=-->
															<!--begin::Status=-->
															<td>POST /v1/customer/c_667822852a047/not_found</td>
															<!--end::Status=-->
															<!--begin::Timestamp=-->
															<td class="pe-0 text-end min-w-200px">20 Dec 2024, 2:40 pm</td>
															<!--end::Timestamp=-->
														</tr>
														<!--end::Table row-->
													</tbody>
