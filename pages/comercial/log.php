...
$TRANSLATIONS = [
    ...
    "event" => [
        ...
        "accept" => "Aceptada", "accepted" => "Aceptada", "in_progress" => "En progreso",
        "confirmed" => "Confirmada", "active" => "Activa", "send" => "Envío", "report" => "Reportar"
    ]
];
?>
...
<div class="logs-page" style="height: calc(100vh - 160px); display: flex; flex-direction: column;">
    ...
    <div class="card" style="flex: 1; display: flex; flex-direction: column; min-height: 0;">
        ...
        <div class="card-body" style="flex: 1; display: flex; flex-direction: column; min-height: 0; padding: 0;">
            <div class="tab-list-container" id="logs-list" style="flex: 1; overflow-y: auto; min-height: 0; padding: 1rem 1.25rem;">
        ...
        <!-- Paginador -->
        <div class="pagination-container" id="logs-pagination" style="flex-shrink: 0; display: none;">
...
(function() {
    ...
    const API_URL = '/api/logs-paginated-sales';
    const TRANSLATIONS = <?php echo json_encode($TRANSLATIONS); ?>;
    
    // Mapeo evento → clase de estado
    const EVENT_STATUS = {
        sign_up: 'success', activate: 'success', create: 'primary', 
        delete: 'danger', accept: 'success', accepted: 'success',
        in_progress: 'warning', confirmed: 'info', active: 'success', 
        send: 'info', report: 'danger', mark_open: 'muted', 
        offer_available: 'warning', mark_read: 'muted'
    };
    ...
    function renderList(data) {
        ...
        listContainer.innerHTML = data.map(log => {
            ...
            return `
                <div class="list-card list-card-${statusClass}" style="margin-bottom: 0.5rem;">
