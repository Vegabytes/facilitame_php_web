...
(function() {
    ...
    const API_URL = '/api/notifications-paginated-sales';
    const API_MARK_ALL = '/api/notifications-mark-all-read-sales';
    const API_MARK_ONE = '/api/notification-mark-read';
    
    // Mapeo status_id → color (ajustar según tu BD)
    const STATUS_COLORS = {
        1: 'primary',   // Iniciada
        2: 'info',      // En proceso
        ...
        5: 'danger',    // Cancelada
        6: 'warning',   // Revisión
        7: 'success',   // Finalizada
        8: 'warning',   // Aplazada
        9: 'danger',    // Eliminada (cambiado de muted a danger)
        10: 'warning',  
        11: 'muted'     
    };
    ...
    function renderList(data) {
        ...
        listContainer.innerHTML = data.map(n => {
            ...
            const badgeColor = STATUS_COLORS[n.status_id] || 'muted';
                    ...
                    <div class="list-card-content">
                        ...
                        <div class="list-card-meta">
                            <span>
                                ...
                                <a href="/request?id=${n.request_id || n.id}" class="text-primary">#${n.id}</a>
                            </span>
                            <span>
                            ...
                            <span>
                                ...
                                ${escapeHtml(n.customer_name || 'Sin nombre')}
                            </span>
                            <span>
    ...
    function handleCardClick(e) {
        // Si clic en enlace, dejar navegación natural
        if (e.target.closest('a')) {
            markAsReadAndGo(this);
            return;
        }
        
        // Clic en card → marcar y navegar
        e.preventDefault();
        markAsReadAndGo(this);
    }
    ...
    function markAsReadAndGo(card) {
        ...
        // Si no está leída, marcarla (fire and forget)
        if (notifStatus == '0') {
            markAsRead(notifId, card);
        }
        
        // Navegar
        window.location.href = `/request?id=${requestId}`;
    }
    ...
    window.filterNotifications = function(query) {
