<!-- ============================================
     APLAZADAS COMERCIAL - PAGINACIÓN SERVER-SIDE
     ============================================ -->
...
(function() {
    ...
    const API_URL = '/api/postponed-paginated-sales';
        ...
        if (!data.length) {
            listContainer.innerHTML = `
                <div class="empty-state">
                    ...
                    <p class="empty-state-text">${state.searchQuery ? `No se encontraron resultados para "${escapeHtml(state.searchQuery)}"` : 'Todas las solicitudes de tus clientes están al día'}</p>
                </div>`;
