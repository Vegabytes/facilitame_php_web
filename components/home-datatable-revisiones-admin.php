<!-- ============================================
     REVISIONES ADMIN - PAGINACIÓN SERVER-SIDE
     ============================================ -->
...
<div class="pagination-container" id="revisiones-pagination" style="display: none;">
    ...
    <div class="pagination-nav">
        <button class="btn-pagination" id="revisiones-prev" disabled><i class="ki-outline ki-left"></i></button>
        <span class="pagination-current" id="revisiones-page-current">1 / 1</span>
        <button class="btn-pagination" id="revisiones-next" disabled><i class="ki-outline ki-right"></i></button>
    </div>
</div>
...
(function() {
    ...
    const API_URL = '/api/reviews-paginated-admin';
        ...
        if (!data.length) {
            listContainer.innerHTML = `
                <div class="empty-state">
                    <div class="empty-state-icon"><i class="ki-outline ki-verify"></i></div>
                ...
                <div class="list-card list-card-info">
                    <div class="list-card-content">
                        ...
                        <div class="list-card-meta">
                            ...
                            <span class="badge-status badge-status-info">En revisión</span>
                        </div>
                    </div>
