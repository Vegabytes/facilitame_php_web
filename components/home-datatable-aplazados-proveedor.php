<!-- ============================================
     APLAZADAS PROVEEDOR - PAGINACI�N SERVER-SIDE
     ============================================ -->
...
<div class="tab-list-container" id="aplazadas-list">
    <div class="loading-state">
        ...
        <span class="ms-2">Cargando aplazadas...</span>
    </div>
</div>

<div class="pagination-container" id="aplazadas-pagination" style="display: none;">
    <div class="pagination-info" id="aplazadas-page-info">P�gina 1 de 1</div>
    <div class="pagination-nav">
        ...
        <button class="btn-pagination" id="aplazadas-next" disabled>
...
(function() {
    ...
    const API_URL = '/api/postponed-paginated-provider';
        ...
        if (!data.length) {
            listContainer.innerHTML = `
                <div class="empty-state">
                    ...
                    <p class="empty-state-text">${state.searchQuery ? `No se encontraron resultados para "${escapeHtml(state.searchQuery)}"` : 'Todas las solicitudes est�n al d�a'}</p>
                </div>`;
    ...
    function updatePaginationControls() {
        ...
        pageInfo.innerHTML = `Mostrando p�gina ${state.currentPage} de ${state.totalPages}`;
