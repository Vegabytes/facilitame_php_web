<!-- ============================================
     SOLICITUDES ADMIN - PAGINACIÓN SERVER-SIDE
...
(function() {
    ...
    const API_URL = '/api/requests-paginated-admin';
        ...
        if (!data.length) {
            ...
            listContainer.innerHTML = `
                <div class="empty-state">
                    ...
                    <p class="empty-state-text">${filterActive ? 'No se encontraron solicitudes con los filtros aplicados' : 'Las nuevas solicitudes aparecerán aquí'}</p>
    ...
    if (document.querySelector('#tab-solicitudes.active, #tab-solicitudes.show')) {
