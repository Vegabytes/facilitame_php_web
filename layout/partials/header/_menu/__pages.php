...
<?php require ROOT_DIR . "/layout/partials/header/_menu/__pages-general.php" ?>
        </div>
        <!--end:Tab pane-->
        <!--begin:Tab pane-->
        <div class="tab-pane  w-lg-600px" id="kt_app_header_menu_pages_account">
<?php require ROOT_DIR . "/layout/partials/header/_menu/__pages-account.php" ?>
        </div>
        <!--end:Tab pane-->
        <!--begin:Tab pane-->
        <div class="tab-pane  w-lg-1000px" id="kt_app_header_menu_pages_authentication">
<?php require ROOT_DIR . "/layout/partials/header/_menu/__pages-authentication.php" ?>
        </div>
        <!--end:Tab pane-->
        <!--begin:Tab pane-->
        <div class="tab-pane  w-lg-1000px" id="kt_app_header_menu_pages_utilities">
<?php require ROOT_DIR . "/layout/partials/header/_menu/__pages-utilities.php" ?>
        </div>
        <!--end:Tab pane-->
        <!--begin:Tab pane-->
        <div class="tab-pane  w-lg-500px" id="kt_app_header_menu_pages_widgets">
<?php require ROOT_DIR . "/layout/partials/header/_menu/__pages-widgets.php" ?>
        </div>
        <!--end:Tab pane-->
    </div>
    <!--end:Tab content-->
