<?php
/**
 * API: api-reviews-paginated.php
 * Paginaci¨®n para solicitudes en revisi¨®n (status_id = 8)
 */
...
try {
    ...
    if (proveedor()) {
        ...
        if (empty($customer_ids)) {
            ...
            json_response("ok", "", 9200003003, $result);
        }
    ...
    error_log("Error en api-reviews-paginated: " . $e->getMessage() . " l¨ªnea " . $e->getLine());
